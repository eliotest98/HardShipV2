...
import it.ship.servlets.gestioneAlbum.Search;
...
class SearchTest {
	...
	@Test
	void search() throws ServletException, IOException {
		when(requestMock.getParameter("pid2")).thenReturn("Par");
		searchTest.doPost(requestMock, responseMock);
